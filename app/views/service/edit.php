            ...
            <div class="span12">
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form action="<?php echo APP_PATH ?>/service/update" method="POST" enctype="multipart/form-data" name="basic_validate" id="basic_validate" class="form-horizontal" novalidate="novalidate">
                                <div class="control-group">
                                    <label class="control-label">Nama Mobil</label>
                                    <div class="controls">
                                    <input type="hidden" name="id" id="id" value="<?php echo $result->id?>">
                                    <input type="text" name="car_name" id="car_name" autocomplete="off" value="<?php echo $result->car_name?>">
                                        <?php 
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                    <input type="text" name="car_type" id="car_type" autocomplete="off" value="<?php echo $result->car_type?>">
                                        <?php 
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                    <input type="number" name="cost" id="cost" autocomplete="off" value="<?php echo $result->cost?>">
                                        <?php 
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                    <textarea name="detail" id="detail" cols="20" rows="5"><?php echo $result->detail?></textarea>
                                    <?php 
